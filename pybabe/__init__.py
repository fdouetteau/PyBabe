...
import kontagent, geo, useragent, format_sqldump, join, format_html, protocol_mail, pivot
...
only_to_load_1 = [transform, mapreduce, format_csv, format_xlsx, types, babelog, compress_zip, protocol_ftp, 
    ...
    compress_gz, partition, kontagent, geo, useragent, format_sqldump, join, format_html, protocol_mail, pivot]
